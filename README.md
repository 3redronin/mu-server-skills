...
- `mu-server-swagger` generates OpenAPI JSON and YAML from Swagger Core v3 annotations, while directing annotation-free applications to Mu Server's built-in OpenAPI support.
